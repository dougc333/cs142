...
(function(){
  ...
  if (typeof cs142MakeMultiFilter !== 'function') {
    ...
    let arraysAreTheSame = function arraysAreTheSame(a1, a2) {
    ...
    let filterFunc = cs142MakeMultiFilter(originalArray);
    
    let secondArray = [1, 2, 3, 4];
    let filterFuncTwo = cs142MakeMultiFilter(secondArray);
